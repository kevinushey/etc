...
# Enable bash completion using Homebrew on OS X
if [ -n "${IS_DARWIN}" ]; then
...
# Launch a lighter weight version of vim (using only
# the 'sensible' set of things). Occasionally handy if
# the extra 100ms of loading regular vim is just too much
# (e.g. git commit messages)
vi () {
